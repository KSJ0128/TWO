...
public interface VisitRepository extends JpaRepository<Visit, Long> {
    ...
    @Query("SELECT DISTINCT new com.togetherwithocean.TWO.Visit.DTO.MyPlaceDTO(v.name, v.latitude, v.longtitude) FROM Visit v WHERE v.member = :member")
    List<MyPlaceDTO> findDistinctNameByMember(@Param("member") Member member);
}
